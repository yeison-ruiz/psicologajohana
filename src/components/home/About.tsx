      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative">
            ...
            <div className="mt-5 lg:absolute lg:-bottom-6 lg:-left-12 bg-white/90 backdrop-blur-md px-5 py-5 lg:px-8 lg:py-8 w-full lg:w-[360px] shadow-xl lg:shadow-[0_15px_45px_0_rgba(0,0,0,0.1)] border-l-[6px] border-[#8A6046] rounded-2xl z-20 transition-transform hover:scale-105 duration-300">
              <span
